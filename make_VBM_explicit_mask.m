...
for i = 1:length(scan_paths)
    oldfilenames{i}= cellstr([split_stem{i}{1} '/structural/wc1' split_stem{i}{2}]);
    newfilenames{i}= cellstr([split_stem{i}{1} '/structural/s_0_wc1' split_stem{i}{2}]);
    try
...
newfilenames = cell(length(scan_paths),1);
for i = 1:length(scan_paths)
    oldfilenames{i}= cellstr([split_stem{i}{1} '/structural/swc1' split_stem{i}{2}]);
    newfilenames{i}= cellstr([split_stem{i}{1} '/structural/s_8_wc1' split_stem{i}{2}]);
    try
        movefile(char(oldfilenames{i}),char(newfilenames{i}));
    catch
    end
