...
# qsub -h  -l nodes=25,mem=8GB,walltime=48:00:00  -o "/group/language/data/thomascope/SD_Wordending/Job2/Job2.log"  -v "MDCE_STORAGE_CONSTRUCTOR=makeFileStorageObject,MDCE_STORAGE_LOCATION=PC%7B%7D%3AUNIX%7B%2Fgroup%2Flanguage%2Fdata%2Fthomascope%2FSD_Wordending%7D%3A,MDCE_JOB_LOCATION=Job2,MDCE_SCHED_TYPE=parallel.cluster.Torque,MDCE_DECODE_FUNCTION=parallel.internal.decode.pbsSimpleParallelTask,MDCE_CMR=/hpc-software/matlab/r2013a,MDCE_MATLAB_EXE=/hpc-software/matlab/r2013a/bin/worker,MDCE_MATLAB_ARGS= -parallel,MDCE_TOTAL_TASKS=25,MDCE_REMSH=ssh,MDCE_USE_ATTACH=off" -N Job2 "/group/language/data/thomascope/SD_Wordending/Job2/pbsParallelWrapper.sh"
