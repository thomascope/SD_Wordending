...
for i = 1:8
jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/SD_Wordending/preprocess/VBM_stats/factorial_single_subject/patient_' num2str(i) '/thresh.nii'],'jet',cfg)
...
myview = [0 90]; % top
%jp_spm8_surfacerender2_version_tc(['/imaging/mlr/users/tc02/SD_Wordending/preprocess/VBM_stats/factorial_full_group_vbm_TIVnormalised_agecovaried_unsmoothedmask/Thresholded_VBM.nii'],'jet',cfg)
